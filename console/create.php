...
//					'migrations/release_1_0_1.php',
			...
			'language-controller' => array(
				'default' => true,
				'dependencies' => array('controller'),
				'files' => array(),
			),
			'tests' => array(
				'default' => true,
	...
	*/
	...
	protected function create_extension()
	{
		...
		$template_engine = new \phpbb\template\twig\twig($this->path_helper, new config(array(
		...
		$skeleton_files = array(
			...
			'config/routing.yml',
			'config/services.yml',
//			'config/tables.yml', // TODO missing
			'controller/main.php',
			'event/main_listener.php',
